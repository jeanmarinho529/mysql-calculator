...
function getValuesRowColumns() {
    ...
    attributes = []
    for (let i = 1; i <= countRows; i++) {
        let attributeType = document.getElementById(`type-${i}`).value
        let attributeLength = document.getElementById(`length-${i}`).value
        let attributeName = document.getElementById(`name-${i}`).value
